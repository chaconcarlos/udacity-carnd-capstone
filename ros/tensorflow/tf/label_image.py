...
if __name__ == "__main__":
    ...
    parser.add_argument("--reader", help="file reader")
    ...
    if reader == 'tensorflow':
        print('using read_tensor_from_image_file')
        t = read_tensor_from_image_file(
            file_name, input_height, input_width=input_width, input_mean=input_mean, input_std=input_std)
    else:
        print('using read_tensor_from_cv2_img')
    ...
    print('Best guess is: {} "{}"'.format(top_k[0], labels[top_k[0]]))
